...
?>
	...
	<br><br><br><br><br>
		...
		<div class="card cong " style="width:100%">
...
<div class="row text-center">
	...
	<p style="font-size: 25px; color:white;">Dziękujemy za rejestrację w serwisie!
Twoje konto zostało założone.

	</p>
	<p style="font-size: 25px; color:white">
	<a href="logowanie.php" > Możesz już się zalogować na swoje konto!</a></p>
	</div>
	</div>
  </div></div>
