...
?>
	...
	<?php
	echo'<div class="card  bg-light mb-3" style="width:100%; opacity:0.9; 	border: 3px solid black;">';
	...
	echo'<div class="Logowanie1"><a href="showzamowienie.php">Status zamówienia produktów</a></div>';
	echo'</div>';
	echo'<br><br>';
	...
	echo'<div class="col-sm-4">';
	echo'<div class="Logowanie33"><a href="index.php">Przejdź do sklepu</a></div>';
	echo'</div>';
