...
{	
    global $link;
			...
			$id_uzytkownika = $_SESSION['id']; 
					$zapytanie2 = "INSERT INTO `zamowienia` (`id_uzytkownika`, `id_towaru`, `data`, `name`, `surname`, `adress`, `miasto`, `ilosc`, `cena`) VALUES ( '$id_uzytkownika', '$id_prod',NOW(), '$imie', '$nazwisko', '$ulica', '$miasto', '$ilosc', '$cena')";
...
?>
	...
	<br><br>
<div class="card border-info mb-3 text-center" style="max-width: auto;margin-right: auto;margin-left: auto;background: rgb(222,69,211);
background: linear-gradient(90deg, rgba(222,69,211,0.23573179271708689) 27%, rgba(153,181,55,0.2413340336134454) 81%); ">
		<div class="card-body ">
	<div class="row text-center">
	<div class="col">
	<p style="font-size: 25px; color:navy;">Dziękujemy za dokonanie zakupu produktów!
	</p>
	<p style="font-size: 25px; color:navy;">
