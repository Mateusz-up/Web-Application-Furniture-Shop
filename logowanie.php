...
?>
	...
	<div class="text-center">
				...
				<div class="login">
    <input type="text" required name="email" placeholder="Email" id="username">  
  <input type="password"  required name="haslo" placeholder="Hasło" id="password">  
...
<div class="shadow"></div>
				...
				<div class="zakladanie_k">
				    
				    <a href="rejestracja.php">Załóż konto</a>
				</div>

	</div>
	<div class="text-center" style="position: relative;bottom:3.5cm;">
				<?php
