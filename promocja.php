...
<a id="button"></a>
	...
	<div class="napisek bg-info text-white">
	<h67>
	Promocje</h67>
...
$wynik = mysqli_query($link,"Select * from promocja ORDER BY cena ".$sortowanie) 
...
if(mysqli_num_rows($wynik) > 0) { 
	...
	if($pozostalo<$dacik2)
	{
	  ...
	  echo '<div class="obramowanie">';
		echo"<h10>";
	   echo "<a style='text-decoration:none'  href='product2.php?product_id=$id'>";
        echo "<b>".$r->nazwa."</b>"; 
		
	echo "<br> </br>";		
      
  
		 echo" <div class='tooltip2'> <img class='zoom' src=images/".$r->id_zdjec.".png width='190' height'120'>";
...
if($id_uzytkownika==5)
{
	...
	echo "<a style='text-decoration:none' href='usuwanie_produktow2.php?usun_id=$id'>";
		...
		echo"</a>";
         ...
         echo '<div class="cenaobw2">';
		 
echo "<b><h5>".$r->cena2. "zł </h5></b>"; 
        echo'</div>';
		 echo '<div class="cenaobw3">';
