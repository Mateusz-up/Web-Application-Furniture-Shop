...
?>
	...
	<div class="powrot">
		<a href="wyswietlanie_koszyka.php">Powrót do koszyka</a>
		</div>
		</div>
</div>
...
<a id="button"></a>
	...
	<?php
		...
		echo'<div class="login3">';
			 echo"<input type='text' required name='imie' placeholder='Imię' onfocus='this.placeholder=''' onblur='this.placeholder='Imię'' />";
				echo"<input type='text' required name='nazwisko' placeholder='Nazwisko' onfocus='this.placeholder=''' onblur='this.placeholder='Nazwisko'' />";	
			 echo"<input type='text' required name='miasto' placeholder='Miasto' onfocus='this.placeholder=''' onblur='this.placeholder='Miasto'' />";
				echo"<input type='text'required  name='ulica' placeholder='Ulica' onfocus='this.placeholder=''' onblur='this.placeholder='Ulica'' />";
